...
export const ContactFAQ = () => {
  ...
  return (
    <section className="py-16 lg:py-24 relative overflow-hidden bg-[#0f172a] border-t border-white/5">
      <div className="absolute right-0 top-1/4 w-[600px] h-[600px] bg-indigo-600/5 blur-[150px] rounded-full pointer-events-none" />

      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <SectionHeader
          title={contactPageData.faqs.headline}
          align="center"
        />

        <div className="max-w-3xl mx-auto space-y-4">
          {contactPageData.faqs.items.map((faq, idx) => (
            <div 
              key={idx}
            ...
            >
              <Button
                ...
                rightIcon={
                  <ChevronDown 
                    className={`w-6 h-6 text-fuchsia-400 shrink-0 transition-transform duration-300 ${openIndex === idx ? "rotate-180" : ""}`} 
                  />
                }
              >
