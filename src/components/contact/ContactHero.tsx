...
export const ContactHero = () => {
  return (
    <section className="relative pt-32 pb-24 lg:pt-48 lg:pb-32 overflow-hidden bg-[#0B1120]">
      {/* Background glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[600px] opacity-20 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-b from-indigo-600 via-fuchsia-600 to-transparent blur-[150px] rounded-full mix-blend-screen" />
      </div>
        ...
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight leading-[1.1] mb-8">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-fuchsia-400">
              {contactPageData.hero.highlight}
            </span>
          </h1>
