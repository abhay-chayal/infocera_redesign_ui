...
export const ClientLogoStrip = () => {
  ...
  return (
    <section className="py-24 bg-[#0B1120] border-b border-white/5 relative overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-indigo-900/10 via-[#0B1120] to-[#0B1120] pointer-events-none" />
